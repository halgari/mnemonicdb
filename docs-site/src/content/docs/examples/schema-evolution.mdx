...
<LiveExample
  ...
  code={`-- Create person/name attribute using the admin view
...
<LiveExample
  ...
  code={`-- Create person/phone attribute using the admin view
INSERT INTO mnemonic_defined_attributes (ident, value_type, cardinality)
...
<LiveExample
  ...
  code={`-- Create person/status attribute using the admin view
INSERT INTO mnemonic_defined_attributes (ident, value_type, cardinality)
